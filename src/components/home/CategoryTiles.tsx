...
type Tile = { name: string; phrase: string; href: string; label: string; tone: PlaceholderTone; src: string; videoSrc?: string };

const tiles: Tile[] = [
  { name: "New In", phrase: "The latest silhouettes", href: "/collections/new-in", label: "New In Editorial", tone: "charcoal", src: lb(27) },
  { name: "Dresses", phrase: "For entrances and evenings", href: "/collections/dresses", label: "Evening Dress", tone: "ink", src: lb(8), videoSrc: "/videos/cat-dresses.mp4" },
  ...
  { name: "Cocktail", phrase: "After dark, softly", href: "/collections/cocktail", label: "Cocktail Evening", tone: "twilight", src: lb(5), videoSrc: "/videos/cat-cocktail.mp4" },
];
